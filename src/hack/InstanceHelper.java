...
//        String filename = "E:\\Prasad\\hackathon\\Click_Predictions\\train\\train-";
        ...
        // CSVReader reader = new CSVReader(new FileReader("train-628.csv"));
        try {
...
//      System.out.println(data);
  ...
  protected static void buildTrainEntry(List<String> allCountryCodes, Instances data,
      CSVReader reader) throws IOException, ParseException {
    String[] line;
...
//      break;
  ...
  private static void setDeviceValues(int i, int j, int k, int l, int m, int n, int index,
      Instance values) {
